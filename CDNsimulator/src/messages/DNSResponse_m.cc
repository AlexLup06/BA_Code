...
DNSResponse::DNSResponse() : ::inet::FieldsChunk()
{
}

DNSResponse::DNSResponse(const DNSResponse& other) : ::inet::FieldsChunk(other)
{
    copy(other);
}
...
int DNSResponse::getServerId() const
{
    return this->serverId;
}

void DNSResponse::setServerId(int serverId)
{
    handleChange();
    this->serverId = serverId;
}

int DNSResponse::getObjectId() const
{
    return this->objectId;
}

void DNSResponse::setObjectId(int objectId)
{
    handleChange();
...
DNSResponseDescriptor::DNSResponseDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::DNSResponse)), "inet::FieldsChunk")
{
